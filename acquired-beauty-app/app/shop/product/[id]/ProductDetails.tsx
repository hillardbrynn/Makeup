...
// Simple props interface for the client component
                            ...
                            <div className="p-8">
                                    ...
                                    <div className="mb-6">
                                        ...
                                        <div className="flex flex-wrap gap-2">
                                            {product.shades.map((shade, index) => (
                                                <button
                                                    key={index}
                                                    className={`w-10 h-10 rounded-full border-2 ${selectedShade === shade ? 'border-rose-500 ring-2 ring-rose-200' : 'border-gray-200'
                                                        }`}
                                ...
                                <div className="flex flex-col sm:flex-row gap-4 mb-6">
                                    <Button
                                        ...
                                        className={`px-10 py-6 rounded-lg shadow transition-all ${addedToCart
                                    ...
                                    <Button
                                        ...
                                        className={`p-6 rounded-lg border ${addedToWishlist
