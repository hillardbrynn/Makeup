                ...
                <div className="max-w-7xl mx-auto px-6 flex justify-between items-center">
                    ...
                    <div className="flex gap-8 text-sm font-medium">
                        ...
                        {user === undefined ? (
                            ...
                            <Link href="/auth" className="hover:text-rose-500 transition-colors">
                                LOGIN / SIGN UP
                            </Link>
                        ) : (
                            <>
                ...
                <div className="max-w-7xl mx-auto px-6 py-12">
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                        ...
                        <div className="space-y-4">
                            <h2 className="text-xl font-serif font-bold tracking-tight">ACQUIRED BEAUTY</h2>
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="flex flex-col space-y-2 text-sm text-gray-600">
                                ...
                                <div className="flex space-x-4">
                                    <a href="https://www.instagram.com/acquired.beauty/" className="hover:text-rose-500 transition-colors">
                                        Instagram
                                    </a>
                                    <a href="https://pin.it/53hF5IU97" className="hover:text-rose-500 transition-colors">
                                        Pinterest
                                    </a>
                                </div>
                            </div>
